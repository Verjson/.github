...
[ ! -e "$root/.github/workflows/generated-artifacts.yml" ] \
  || fail ".github/workflows/generated-artifacts.yml is a retired duplicate caller path; generate exactly one .github/workflows/changelog.yml"
