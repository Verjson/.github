...
class PromotionTest(unittest.TestCase):
    def setUp(self):
        ...
        self.candidate = {"schemaVersion": 1, "kind": "container-candidate", "candidateVersion": "1.2.3-rc.12345.1", "source": {"repository": "Verjson/example", "commit": "a" * 40, "ref": "refs/heads/main", "workflow": workflow, "runId": "12345", "runAttempt": "1"}, "images": [{"variant": "default", "repository": "ghcr.io/verjson/example", "indexDigest": digest, "identities": {"commit": "sha-" + "a" * 40, "candidate": "1.2.3-rc.12345.1"}, "platforms": [{"os": "linux", "architecture": "amd64", "digest": "sha256:" + "2" * 64}], "provenance": {"predicateType": "https://slsa.dev/provenance/v1", "builderIdentity": workflow, "subjectDigest": digest, "attestationId": "attestation-1"}, "sbom": {"predicateType": "https://spdx.dev/Document", "subjectDigest": digest, "ociSubject": "ghcr.io/verjson/example@" + digest}}]}
        self.state = {"candidateManifestDigest": "sha256:" + "9" * 64, "aliases": {}, "release": {"workflow": {"path": ".github/workflows/container-release.yml", "contractCommit": "c" * 40}, "runId": 456, "runAttempt": 1}, "timestamps": {"candidatePublishedAt": "2026-08-09T00:00:00Z", "releasedAt": "2026-08-09T01:00:00Z"}, "previousRelease": None, "provenance": {"default": "sha256:" + "7" * 64}, "sbom": {"default": "sha256:" + "5" * 64}}
