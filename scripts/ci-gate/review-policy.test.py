...
checks = {
    ...
    "raw policy JSON never crosses Actions outputs": (
        "review_policy=$review_policy_json" not in arm
        and "select_compatible_review_policy" in arm
        and "base64 -w0" in arm
    ),
