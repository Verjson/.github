...
def contract(candidate_gate=gate, candidate_arm=arm, candidate_policy=policy):
    checks = {
        ...
        "AI requires explicit opt-in": '== "ai-review"' in candidate_gate and 'AI review explicitly requested' in candidate_gate,
        ...
        "unrequested code uses human approval": "code change — human approval path; AI review not requested" in candidate_gate,
...
print("PASS: human fallback, opt-in AI authority, and the two-pass DeepSeek cascade are contract-bound")
