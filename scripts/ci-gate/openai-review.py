...
SCHEMA = {"type": "object", "properties": {
    ...
    "findings": {"type": "array", "items": {"type": "object", "properties": {"location": {"type": "string", "description": "Exactly one repository-relative file and one positive line number (path/to/file.ext:42); no ranges or comma-separated locations."}, "reason": {"type": "string"}, "failure_scenario": {"type": "string"}, "evidence": {"type": "string"}}, "required": ["location", "reason", "failure_scenario", "evidence"], "additionalProperties": False}},
