...
test "\$(sha256sum .github/workflows/container-deployment-security-review.yml | cut -d' ' -f1)" = "$security_review_digest"
test "\$(sha256sum .github/workflows/container-deployment-ai-review.yml | cut -d' ' -f1)" = "$ai_review_digest"
test "\$(sha256sum .github/workflows/container-deployment-review-producer.yml | cut -d' ' -f1)" = "$review_workflow_digest"
test "\$(sha256sum scripts/container_deployment_review_producer.py | cut -d' ' -f1)" = "$review_producer_digest"
test -f "$config"
jq -e '
  .schemaVersion == 1 and
