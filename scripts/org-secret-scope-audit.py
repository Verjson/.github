...
def main() -> int:
    ...
    failures = []
    # A withdrawn secret is expected to be absent: its broad organization copy is the
    # exposure #1285 removes, so absence is conformance rather than a manifest gap.
    withdrawn = {
