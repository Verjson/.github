...
- [#660](https://github.com/Verjson/.github/issues/660) — Accept documented Responses API reasoning items alongside exactly one completed assistant message without weakening model, usage-envelope, or refusal validation.
