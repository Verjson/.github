...
- [#1084](https://github.com/Verjson/.github/issues/1084) — Add an observe-first dependency-update supersession detector and a separately authenticated, exact-repository terminal reconciler under ADR 0136. Blocked on provisioning the purpose-specific GitHub App before write-mode implementation or canary.
