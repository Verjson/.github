...
- [#490](https://github.com/Verjson/.github/issues/490) — `privileged_merge` fails hard on a transient 500 from the PR file list, with no retry, while its own CI poll loop retries the analogous case. Hit twice on 2026-08-07 (#479, #486); a plain job re-run cleared both. Compounds #475.
