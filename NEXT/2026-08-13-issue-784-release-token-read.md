...
Behavioral and mutation tests reject restoring the obsolete Actions-token write grant, and ADR 0099 records why the App-backed push no longer depends on it.
