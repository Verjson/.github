...
Allow container-candidate adopters to select an integrity-pinned pnpm 9 lockfile while preserving exact private-package scope, lifecycle isolation, and credential-free Docker delivery.
