...
Pull requests and forks remain confined to the existing secretless PR boundary. Trusted pushes cannot be deferred by a stale `renovate/stability-days` status, and ADR 0096 records the event, permission, package-token, and runner split.
