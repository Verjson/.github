...
semantic contract locks the trigger, checkout, named-step, command, and
token-ordering boundaries across alternate valid YAML spellings. ADR 0049 records
the fix and the residual #261/#265 secret-scope work.
