...
The schedule is concurrency-safe and protected by the shared semantic privileged-workflow contract. Malformed or duplicate policy and GitHub API data now produces controlled fail-closed diagnostics.
