...
ADR 0091 records the one-for-one migration order. The live ruleset remains unchanged until every governed default branch has deterministic required CI and passes full ruleset-image, rollback, App scope, repository-shadowing, hosted-runner, trigger, and exclusivity checks.
