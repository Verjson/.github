...
The live rollout is verified by a controlled documentation-only pull request whose
terminal continuation must execute on the admitted hosted lane before merging.
