...
ADR 0065 defines validation, selection, rendering, pull-request, and release invariants so scoped notes cannot silently leak into another immutable snapshot.
