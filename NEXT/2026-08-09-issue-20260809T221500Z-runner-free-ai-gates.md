...
Prohibit both AI review and privileged merge jobs from polling or sleeping while external CI is pending, preserving event-driven exact-head terminal promotion for #341.
