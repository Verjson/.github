...
| # | Date | Decision |
|---|------|----------|
| [0157](0157-pre-credential-release-reconciliation-hook/README.md) | 2026-09-01 | Container releases reconcile derived inputs before minting the release credential |
